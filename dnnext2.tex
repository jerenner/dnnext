...
background events accepted (see ).  Thus we define a figure of merit $F = n_s/\sqrt{n_b}$, where $s$ and $b$ are the fractions of signal and background events accepted.  This quantity is 
